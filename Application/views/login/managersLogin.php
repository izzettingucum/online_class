...
?>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?=SITE_URL?>/login/managerLogin" method="post">
        ...
        <div class="row">
        <div class="col-12">
            <a href="login/studentLogin"><button type="submit" class="btn btn-primary btn-block">Giriş Yap</button></a>
        </div>
        </div>
        </form>
        <br>
        <div class="row">
        <div class="col-12">
            <a href="<?=SITE_URL?>/forgetPassword/managerForget"><button type="submit" class="btn btn-danger btn-block">Şifremi Unuttum</button></a>
        </div>
        </div>
    </div>
    <!-- /.login-card-body -->
