...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?=SITE_URL?>/login/studentLogin" method="post">
        ...
        <div class="row">
        <div class="col-12">
            <a href="<?=SITE_URL?>/forgetPassword/studentForget"><button type="submit" class="btn btn-danger btn-block">Şifremi Unuttum</button></a>
        </div>
        </div>
    </div>
    <!-- /.login-card-body -->
