...
<div class="login-box">
  ...
  <div class="card">
    ...
    <form action="<?=SITE_URL?>/login/teacherLogin" method="post">
        ...
        <div class="row">
        <div class="col-12">
            <a href="<?=SITE_URL?>/forgetPassword/teacherForget"><button type="submit" class="btn btn-danger btn-block">Şifremi Unuttum</button></a>
        </div>
        </div>
      </form>
    </div>
